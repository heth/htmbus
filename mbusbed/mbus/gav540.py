...
"""
gav540.py - M-Bus specific file for Carlo Gavazzi EM530-EM540 Energy analyzer
"""
...
async def read(devdesc):
    ...
    if slave['Manufacturer'] == 'GAV':
        devdesc['manufacturer'] = 'Carlo Gavazzi'
        if slave['Version'] == '222':  # Multical 603
            devdesc['model'] = 'EM540'
